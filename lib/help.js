...
module.exports = (version) => {
  console.log(
    "\nWelcome to MAAS CLI. MAAS CLI controls and configures your virtual machines, hardware and devices."
  );
  ...
  //Basic actions
  console.log("\nBasic machine actions: ".bold);
  console.log(pad(" allocate", standard_pad), "Acquire all ready machines.");

  console.log(
    pad(" commission", standard_pad),
